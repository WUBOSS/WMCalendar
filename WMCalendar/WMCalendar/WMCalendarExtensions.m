...
@implementation UIView (WMCalendarExtensions)
...
@implementation CALayer (WMCalendarExtensions)
...
@interface NSCalendar (WMCalendarExtensionsPrivate)

@property (readonly, nonatomic) NSDateComponents *fs_privateComponents;

@end

@implementation NSCalendar (WMCalendarExtensions)
...
@implementation NSMapTable (WMCalendarExtensions)
...
@implementation NSCache (WMCalendarExtensions)
...
@implementation NSObject (WMCalendarExtensions)

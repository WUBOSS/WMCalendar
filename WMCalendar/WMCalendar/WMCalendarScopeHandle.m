...
@interface WMCalendarScopeHandle () <UIGestureRecognizerDelegate>
...
@end
@implementation WMCalendarScopeHandle
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        view.layer.backgroundColor = WMCalendarStandardScopeHandleColor.CGColor;
        [self addSubview:view];

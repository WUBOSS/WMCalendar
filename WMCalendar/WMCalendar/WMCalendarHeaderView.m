...
@interface WMCalendarHeaderView ()<UICollectionViewDataSource,UICollectionViewDelegate>

- (void)scrollToOffset:(CGFloat)scrollOffset animated:(BOOL)animated;
- (void)configureCell:(WMCalendarHeaderCell *)cell atIndexPath:(NSIndexPath *)indexPath;
...
- (void)initialize
{
    ...
    WMCalendarHeaderLayout *collectionViewLayout = [[WMCalendarHeaderLayout alloc] init];
    self.collectionViewLayout = collectionViewLayout;
    
    WMCalendarCollectionView *collectionView = [[WMCalendarCollectionView alloc] initWithFrame:CGRectZero collectionViewLayout:collectionViewLayout];
    ...
    [collectionView registerClass:[WMCalendarHeaderCell class] forCellWithReuseIdentifier:@"cell"];
...
{
    WMCalendarHeaderCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
    cell.header = self;
...
- (void)configureCell:(WMCalendarHeaderCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    WMCalendarAppearance *appearance = self.calendar.appearance;
    ...
    BOOL usesUpperCase = (appearance.caseOptions & 15) == WMCalendarCaseOptionsHeaderUsesUpperCase;
    NSString *text = nil;
...
{
    [self.collectionView.visibleCells enumerateObjectsUsingBlock:^(__kindof WMCalendarHeaderCell * _Nonnull cell, NSUInteger idx, BOOL * _Nonnull stop) {
...
@implementation WMCalendarHeaderCell
...
@implementation WMCalendarHeaderLayout
...
@implementation WMCalendarHeaderTouchDeliver
